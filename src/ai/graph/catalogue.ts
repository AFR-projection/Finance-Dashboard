...
export const NODE_DEFINITIONS: Record<AgentNodeKind, NodeDefinition> = {
  ...
  "llm.reasoner": {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Batas waktu satu panggilan (ms)",
        type: "number",
        default: 60000,
        min: 5000,
        max: 300000,
        step: 1000,
        hint: "fetch bawaan Node tidak punya batas waktu sendiri. Tanpa angka ini, satu panggilan yang menggantung menahan balasan selamanya.",
      },
      {
        key: "maxRetries",
        label: "Percobaan ulang saat gangguan sementara",
        type: "number",
        default: 2,
        min: 0,
        max: 5,
        hint: "Hanya untuk 429, 5xx, dan putus jaringan. Permintaan yang memang salah tidak pernah diulang.",
      },
      {
        key: "totalBudgetMs",
        label: "Batas waktu seluruh balasan (ms)",
        type: "number",
        default: 180000,
        min: 10000,
        max: 600000,
        step: 5000,
        hint: "Mencakup semua putaran, model cadangan, dan percobaan ulang sekaligus. Habis batas, agent menjawab dari data yang sudah terkumpul.",
      },
    ],
  },
  ...
  "llm.analyst": {
    ...
    fields: [
      ...
      {
        key: "totalBudgetMs",
        label: "Batas waktu seluruh analisis (ms)",
        type: "number",
        default: 120000,
        min: 10000,
        max: 600000,
        step: 5000,
        hint: "Tick heartbeat mengerjakan user satu per satu. Tanpa batas ini, satu user yang macet menahan giliran semua user berikutnya.",
      },
    ],
  },
